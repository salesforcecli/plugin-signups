...
_See code: [src/commands/org/create/shape.ts](https://github.com/salesforcecli/plugin-signups/blob/2.3.4/src/commands/org/create/shape.ts)_
...
_See code: [src/commands/org/create/snapshot.ts](https://github.com/salesforcecli/plugin-signups/blob/2.3.4/src/commands/org/create/snapshot.ts)_
...
_See code: [src/commands/org/delete/shape.ts](https://github.com/salesforcecli/plugin-signups/blob/2.3.4/src/commands/org/delete/shape.ts)_
...
_See code: [src/commands/org/delete/snapshot.ts](https://github.com/salesforcecli/plugin-signups/blob/2.3.4/src/commands/org/delete/snapshot.ts)_
...
_See code: [src/commands/org/get/snapshot.ts](https://github.com/salesforcecli/plugin-signups/blob/2.3.4/src/commands/org/get/snapshot.ts)_
...
_See code: [src/commands/org/list/shape.ts](https://github.com/salesforcecli/plugin-signups/blob/2.3.4/src/commands/org/list/shape.ts)_
...
_See code: [src/commands/org/list/snapshot.ts](https://github.com/salesforcecli/plugin-signups/blob/2.3.4/src/commands/org/list/snapshot.ts)_
